...
function TabPanel:createChildren()
	...
	-- Setup colors.
	self.colorOutline      = UIColor(128, 128, 128, 255);
	self.colorText         = UIColor(164, 164, 164, 255);
	self.colorTextSelected = UIColor(240, 240, 240, 255);
...
function TabPanel:update()
	...
	if self.active_panel ~= nil then self.active_panel:update() end
...
--
----------------------------------------------------------------
function TabPanel:getActiveTab() return self.active_panel end

----------------------------------------------------------------
--
----------------------------------------------------------------
function TabPanel:getInnerX() return self.inner_x end

----------------------------------------------------------------
--
----------------------------------------------------------------
function TabPanel:getInnerY() return self.inner_y end

----------------------------------------------------------------
--
----------------------------------------------------------------
function TabPanel:getInnerWidth() return self.inner_width end

----------------------------------------------------------------
--
----------------------------------------------------------------
function TabPanel:getInnerHeight() return self.inner_height end
